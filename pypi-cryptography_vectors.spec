...
Version  : 44.0.2
Release  : 153
URL      : https://files.pythonhosted.org/packages/83/a8/7e7d6d01e21fb5522d3df1e981f2bd80faada85ba8b57f6a5e0017098e10/cryptography_vectors-44.0.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/83/a8/7e7d6d01e21fb5522d3df1e981f2bd80faada85ba8b57f6a5e0017098e10/cryptography_vectors-44.0.2.tar.gz
...
%prep
%setup -q -n cryptography_vectors-44.0.2
cd %{_builddir}/cryptography_vectors-44.0.2
pushd ..
cp -a cryptography_vectors-44.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741174101
