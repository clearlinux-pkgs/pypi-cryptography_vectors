...
Version  : 42.0.0
Release  : 137
URL      : https://files.pythonhosted.org/packages/f0/62/d30b2777a54ad7ce62e5b9f024ee6135131d06340e4fce4313ba740394fb/cryptography_vectors-42.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f0/62/d30b2777a54ad7ce62e5b9f024ee6135131d06340e4fce4313ba740394fb/cryptography_vectors-42.0.0.tar.gz
...
%prep
%setup -q -n cryptography_vectors-42.0.0
cd %{_builddir}/cryptography_vectors-42.0.0
pushd ..
cp -a cryptography_vectors-42.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706023268
