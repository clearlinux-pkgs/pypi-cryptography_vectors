...
Version  : 37.0.2
Release  : 108
URL      : https://files.pythonhosted.org/packages/1d/dc/23867034d7500dab0e1fcc29510971ccd9bedf141ac0091d9cdf99a109c6/cryptography_vectors-37.0.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/1d/dc/23867034d7500dab0e1fcc29510971ccd9bedf141ac0091d9cdf99a109c6/cryptography_vectors-37.0.2.tar.gz
Source1  : https://files.pythonhosted.org/packages/1d/dc/23867034d7500dab0e1fcc29510971ccd9bedf141ac0091d9cdf99a109c6/cryptography_vectors-37.0.2.tar.gz.asc
...
%prep
%setup -q -n cryptography_vectors-37.0.2
cd %{_builddir}/cryptography_vectors-37.0.2
pushd ..
cp -a cryptography_vectors-37.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653054844
...
cp %{_builddir}/cryptography_vectors-37.0.2/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/pypi-cryptography_vectors/de33ead2bee64352544ce0aa9e410c0c44fdf7d9
cp %{_builddir}/cryptography_vectors-37.0.2/LICENSE.BSD %{buildroot}/usr/share/package-licenses/pypi-cryptography_vectors/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
