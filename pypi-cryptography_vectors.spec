...
Version  : 42.0.5
Release  : 142
URL      : https://files.pythonhosted.org/packages/a8/7f/20a3d24cb1b88a0225c7829c3e7bde038de26d114176a65bfc713065466f/cryptography_vectors-42.0.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/a8/7f/20a3d24cb1b88a0225c7829c3e7bde038de26d114176a65bfc713065466f/cryptography_vectors-42.0.5.tar.gz
...
%prep
%setup -q -n cryptography_vectors-42.0.5
cd %{_builddir}/cryptography_vectors-42.0.5
pushd ..
cp -a cryptography_vectors-42.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708967525
