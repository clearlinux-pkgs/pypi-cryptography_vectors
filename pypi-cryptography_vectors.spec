...
Version  : 44.0.0
Release  : 150
URL      : https://files.pythonhosted.org/packages/c0/f6/610f0f3432de4b146bb249fa2802de521f0d745cd7867be06dd7c9be2dcc/cryptography_vectors-44.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/c0/f6/610f0f3432de4b146bb249fa2802de521f0d745cd7867be06dd7c9be2dcc/cryptography_vectors-44.0.0.tar.gz
...
%prep
%setup -q -n cryptography_vectors-44.0.0
cd %{_builddir}/cryptography_vectors-44.0.0
pushd ..
cp -a cryptography_vectors-44.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732747899
