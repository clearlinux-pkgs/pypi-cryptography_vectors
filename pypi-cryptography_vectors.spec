...
Version  : 37.0.3
Release  : 109
URL      : https://files.pythonhosted.org/packages/1e/fa/43501fc2dd3d23a6c82d9d186bdbf7c606028288f076fdc0cf459d7b6140/cryptography_vectors-37.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/1e/fa/43501fc2dd3d23a6c82d9d186bdbf7c606028288f076fdc0cf459d7b6140/cryptography_vectors-37.0.3.tar.gz
...
%prep
%setup -q -n cryptography_vectors-37.0.3
cd %{_builddir}/cryptography_vectors-37.0.3
pushd ..
cp -a cryptography_vectors-37.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655855988
...
cp %{_builddir}/cryptography_vectors-37.0.3/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/pypi-cryptography_vectors/de33ead2bee64352544ce0aa9e410c0c44fdf7d9
cp %{_builddir}/cryptography_vectors-37.0.3/LICENSE.BSD %{buildroot}/usr/share/package-licenses/pypi-cryptography_vectors/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
