...
Version  : 43.0.0
Release  : 146
URL      : https://files.pythonhosted.org/packages/3c/2c/bf69ff5872ca0b99d16b77450c337a73b863ac2bcfee8b3fe7808ca6d9d9/cryptography_vectors-43.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/3c/2c/bf69ff5872ca0b99d16b77450c337a73b863ac2bcfee8b3fe7808ca6d9d9/cryptography_vectors-43.0.0.tar.gz
...
%prep
%setup -q -n cryptography_vectors-43.0.0
cd %{_builddir}/cryptography_vectors-43.0.0
pushd ..
cp -a cryptography_vectors-43.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721661967
