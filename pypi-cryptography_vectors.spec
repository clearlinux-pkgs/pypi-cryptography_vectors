...
Version  : 44.0.3
Release  : 154
URL      : https://files.pythonhosted.org/packages/fb/1c/c53bf81cf7d7f4010d19b08b86d3bcfe69eeb50541e56d92e80859254864/cryptography_vectors-44.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/fb/1c/c53bf81cf7d7f4010d19b08b86d3bcfe69eeb50541e56d92e80859254864/cryptography_vectors-44.0.3.tar.gz
...
%prep
%setup -q -n cryptography_vectors-44.0.3
cd %{_builddir}/cryptography_vectors-44.0.3
pushd ..
cp -a cryptography_vectors-44.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746463980
