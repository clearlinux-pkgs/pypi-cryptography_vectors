...
Source0  : https://files.pythonhosted.org/packages/3c/c4/43ac7949cb457ba6a51651b112ba63b23e8916b140c48c781754755a1a29/cryptography_vectors-42.0.8.tar.gz
...
%prep
%setup -q -n cryptography_vectors-42.0.8
cd %{_builddir}/cryptography_vectors-42.0.8
pushd ..
cp -a cryptography_vectors-42.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717550584
