...
%prep
%setup -q -n cryptography_vectors-43.0.3
cd %{_builddir}/cryptography_vectors-43.0.3
pushd ..
cp -a cryptography_vectors-43.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729272330
