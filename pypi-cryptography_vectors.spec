...
Version  : 41.0.5
Release  : 133
URL      : https://files.pythonhosted.org/packages/98/50/4ad39caf3614011bd31c1d058e67e29c1b0e01346058ee625ed7f7da0b92/cryptography_vectors-41.0.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/98/50/4ad39caf3614011bd31c1d058e67e29c1b0e01346058ee625ed7f7da0b92/cryptography_vectors-41.0.5.tar.gz
...
%prep
%setup -q -n cryptography_vectors-41.0.5
cd %{_builddir}/cryptography_vectors-41.0.5
pushd ..
cp -a cryptography_vectors-41.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698167153
